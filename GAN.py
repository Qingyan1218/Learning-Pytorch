...
def train_a_gan(D_net, G_net, D_optimizer, G_optimizer, discriminator_loss, generator_loss, show_every=250,
    ...
    for epoch in range(num_epochs):
        for x, _ in train_data:
            ...
            gen_logits_fake = D_net(fake_images)  # 判别网络对生成的假的数据的得分
...
train_a_gan(D, G, D_optim, G_optim, discriminator_loss, generator_loss,num_epochs=2)
...
train_dc_gan(D_DC, G_DC, D_DC_optim, G_DC_optim, discriminator_loss, generator_loss, num_epochs=2)
